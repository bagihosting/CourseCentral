...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        title: `Syarat & Ketentuan - ${seoSettings.platformName}`,
    };
}
      ...
      <main className="container mx-auto py-12 md:py-16 px-4">
        <Card>
          ...
          <CardContent className="prose dark:prose-invert max-w-none">
            <p>Dengan mengakses dan menggunakan platform {platformName}, Anda setuju untuk terikat oleh Syarat dan Ketentuan berikut.</p>
            ...
            <h2>2. Konten</h2>
            <p>Konten yang disediakan di platform ini, termasuk kursus, materi, dan teks, adalah milik {platformName} dan/atau para instrukturnya. Konten ini dilindungi oleh hak cipta dan tidak boleh didistribusikan ulang tanpa izin tertulis.</p>
            
            <h2>3. Pembayaran dan Keanggotaan Pro</h2>
            <p>Beberapa fitur mungkin memerlukan pembayaran atau keanggotaan Pro. Pembayaran bersifat final dan tidak dapat dikembalikan. {platformName} berhak untuk mengubah biaya keanggotaan kapan saja.</p>

            <h2>4. Pembatasan Tanggung Jawab</h2>
            <p>Layanan kami disediakan "sebagaimana adanya". {platformName} tidak memberikan jaminan apa pun, tersurat maupun tersirat, dan dengan ini menafikan semua jaminan lainnya. {platformName} tidak akan bertanggung jawab atas segala kerusakan yang timbul dari penggunaan atau ketidakmampuan untuk menggunakan materi di situs web kami.</p>
