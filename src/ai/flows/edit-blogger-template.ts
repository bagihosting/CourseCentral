...
const prompt = ai.definePrompt({
  ...
  prompt: `
    You are an expert Blogger theme developer. Your task is to modify an existing Blogger template based on a user's request.
    You must carefully apply the changes while preserving the overall structure, responsiveness, and validity of the original template.
    ...
    **CRITICAL INSTRUCTIONS:**
    ...
    3.  **Maintain Validity**: The final output MUST be a single, complete, and well-formed Blogger XML template. Do not break the XML structure.
